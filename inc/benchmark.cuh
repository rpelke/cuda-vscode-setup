...
class Benchmark {
  ...
  private:
    ...
    void benchmark_triple_softmax_kernel(int M, int K,
                          dim3 gridDim, dim3 gridDim_k1, dim3 blockDim, softmax_init_kernel_t k0, softmax_followUp_kernel_t k1, softmax_followUp_kernel_t k2, std::string kernel_name, float atol);
