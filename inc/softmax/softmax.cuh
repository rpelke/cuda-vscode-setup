...
__global__ void softmax_block_binary_k0(int M, int N, const float *A, float *C,
                                        float *temp);
__global__ void softmax_block_binary_k1(int M, int N, const float *A, float *C,
                                        float *temp, int gridDim_y_k0);
__global__ void softmax_block_binary_k2(int M, int N, const float *A, float *C,
                                        float *temp, int gridDim_y_k0);

__global__ void softmax_binary_non_divergent_k0(int M, int N, const float *A,
                                                float *C, float *temp);
__global__ void softmax_binary_non_divergent_k1(int M, int N, const float *A,
                                                float *C, float *temp,
                                                int gridDim_y_k0);

__global__ void softmax_sequential_access_k0(int M, int N, const float *A,
                                             float *C, float *temp);
__global__ void softmax_sequential_access_k1(int M, int N, const float *A,
                                             float *C, float *temp,
                                             int gridDim_y_k0);
